...
import 'data_kandidat_screen.dart';
import 'hasil_voting_screen.dart';
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          child: Row(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              Icon(icon, size: 20, color: isPrimary ? AppColors.primary : Colors.white.withOpacity(0.9)),
              const SizedBox(width: 12),
              Text(
                label,
                style: GoogleFonts.inter(
                  color: isPrimary ? AppColors.primary : Colors.white.withOpacity(0.9),
                  fontSize: 15,
...
// Batas akhir file, jangan dihapus