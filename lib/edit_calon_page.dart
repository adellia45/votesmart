...
class EditCalonPage extends StatefulWidget {
  ...
  @override
  State<EditCalonPage> createState() => _EditCalonPageState();
}

class _EditCalonPageState extends State<EditCalonPage> {
  ...
  void initState() {
    ...
    _visiController = TextEditingController(text: widget.visi);
    _misiController = TextEditingController(text: widget.misi);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          'Profile Calon ${widget.tipeCalon}',
